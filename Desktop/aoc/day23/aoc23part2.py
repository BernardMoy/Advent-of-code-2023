...
for jct in jctlist:
    ...
    while len(current) != 0:
        ...
        for i in range(len(current)):
            ...
            # Else
            if pos[0]>0 and lines[pos[0]-1][pos[1]] != '#' and (pos[0]-1,pos[1]) not in visited:
                current.append((pos[0]-1, pos[1]))
            if pos[0]<vlen-1 and lines[pos[0]+1][pos[1]] != '#' and (pos[0]+1,pos[1]) not in visited:
                current.append((pos[0]+1, pos[1]))
            if pos[1]>0 and lines[pos[0]][pos[1]-1] != '#' and (pos[0],pos[1]-1) not in visited:
                current.append((pos[0], pos[1]-1))
            if pos[1]<hlen-1 and lines[pos[0]][pos[1]+1] != '#' and (pos[0],pos[1]+1) not in visited:
                current.append((pos[0], pos[1]+1))
