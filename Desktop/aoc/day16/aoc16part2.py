...
# Right
for i in range(vlen):
    all_energized.append(find_energized((i, -1, 'right')))
# Left
for i in range(vlen):
    all_energized.append(find_energized((i, hlen, 'left')))
# Up
for i in range(hlen):
    all_energized.append(find_energized((vlen, i, 'up')))
# Down
for i in range(hlen):
    all_energized.append(find_energized((-1, i, 'down')))

print(max(all_energized))
